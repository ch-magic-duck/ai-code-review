...
public class AiCodeReview {
    ...
    private static String codeReview(String diffCode) throws Exception {
        ...
        String apiKeySecret = "91ed753fd9ac43749536624795994fe6.YCHMxiISaiWAAB7S";
    ...
    private static String writeLog(String token, String log) throws Exception {
        Git git = Git.cloneRepository()
                .setURI("https://github.com/ch-magic-duck/ai-code-review-log.git")
        ...
        return "https://github.com/ch-magic-duck/ai-code-review-log/blob/master/" + dateFolderName + "/" + fileName;
    }
